...
# databricks_iris_19 documentation build
...
from databricks_iris_19 import __version__ as release

# -- Project information -----------------------------------------------------

project = "databricks_iris_19"
author = "Kedro"
...
htmlhelp_basename = "databricks_iris_19doc"
...
latex_documents = [
    (
        master_doc,
        "databricks_iris_19.tex",
        "databricks_iris_19 Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "databricks_iris_19",
        "Project databricks_iris_19 codebase.",
        "Nearest-Neighbour",
    )
]
